package oit.is.z0908.kaizi.janken.model;
...
public interface MatchMapper {
   ...
   * @return
   */
  // @Select("select CHAMBER.USER,CHAMBER.NUMBER,USERINFO.HEIGHT from CHAMBER JOIN
  // USERINFO ON CHAMBER.USER=USERINFO.USER;")
  ...
  // void insertChamber(Users chamber);
